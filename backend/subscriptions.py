...
SUBSCRIPTION_TIERS = {
    "basic": {
        ...
        "description": "Everything you need to start recruiting — track up to 3 schools with full Pro features.",
        "features": [
            "Track up to 3 schools",
            "Send & receive coach emails inside the app",
            "Smart follow-up reminders",
            "Recruiting analytics dashboard",
            "Public athlete profile (shareable with coaches)",
            "Unlimited match & fit scores",
    ...
    "pro": {
        ...
        "features": [
            "Actively manage up to 25 schools",
            "Send & receive coach emails inside the app",
            "Smart follow-up reminders",
            "Know which coaches are engaging",
            "Public athlete profile (shareable with coaches)",
            "Recruiting analytics dashboard",
            "Unlimited match & fit scores",
            "2 family/team members",
        ],
    },
    "premium": {
        "label": "Premium",
        ...
        "features": [
            ...
            "Automatic coach reply detection",
            "Weekly recruiting progress digest",
            "Full recruiting analytics suite",
            "Coach Watch Alerts (real-time program updates that could impact your recruiting)",
            "Priority support",
            "Unlimited family & staff collaborators",
        ],
    },
}
