"""
D2 Social Media Scraper
Scrapes social media links from D2 school athletics websites using Playwright.
Run: python3 scripts/social_scraper_d2.py
"""
...
async def main():
    ...
    total = len(schools)
    print(f"[{datetime.now(timezone.utc).isoformat()}] Starting D2 social scraper: {total} schools")
