    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col items-center gap-3 relative z-10">
          <div className="w-12 h-12 rounded-full bg-pink-600/15 flex items-center justify-center">
          ...
          <button
            className="mt-2 px-4 py-2 rounded-lg bg-gradient-to-r from-pink-600 to-rose-600 text-white text-xs font-semibold hover:from-pink-500 hover:to-rose-500 transition-all flex items-center gap-2 shadow-lg shadow-pink-900/30"
