            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
              {messages.length === 0 ? (
                <div className="flex flex-col items-center pt-8 px-4">
                  <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-pink-500/15 to-violet-600/15 flex items-center justify-center mb-4">
                ...
                messages.map((msg, i) => (
                  <div key={i} className={`flex ${msg.role === "user" ? "justify-end" : "justify-start"}`}>
                    ...
                    >
                      ...
                      <p className={`text-[9px] mt-1 ${msg.role === "user" ? "text-pink-200" : ""}`} style={msg.role === "assistant" ? { color: "var(--t-text-faint)" } : {}}>
                        {formatTime(msg.time)}
                      </p>
                    </div>
                  </div>
            ...
            <div className="border-t p-3" style={{ borderColor: "var(--t-border)" }}>
              <div className="flex items-end gap-2">
                ...
                <button
                  ...
                  className="p-2.5 rounded-xl bg-pink-600 text-white hover:bg-pink-500 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
