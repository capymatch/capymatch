      ...
      <section className="relative overflow-hidden" style={{ background: "var(--p-hero-bg)" }}>
        ...
        <div className="relative z-10 px-5 py-8 flex flex-col items-center text-center">
          ...
          {hasPhoto ? (
            ...
            <div className="w-36 h-44 rounded-[16px] bg-gradient-to-br from-[#1a8a80] to-indigo-500 flex items-center justify-center shadow-lg mb-5">
          ...
          <div className="flex flex-wrap gap-2 mt-5 justify-center">
            ...
            {profile.video_link && (
              <span className="inline-flex items-center gap-1.5 px-4 py-2 rounded-full text-[11px] font-semibold text-white bg-[#1a8a80]">
