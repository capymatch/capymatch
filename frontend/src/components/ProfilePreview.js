...
function StatCard({ value, label }) {
  ...
  return (
    <div className="rounded-2xl text-center" style={{ background: "#f2f3f8", border: "1px solid rgba(0,0,0,0.06)", padding: "20px 12px" }}>
      ...
      <div className="text-[9px] font-medium uppercase tracking-[1.5px] mt-1.5" style={{ color: "var(--p-text-muted)" }}>{label}</div>
    </div>
  );
}
      ...
      <section className="relative overflow-hidden" style={{ background: "var(--p-hero-bg)" }}>
        ...
        <div className="relative z-10 px-5 py-8 flex flex-col items-center text-center">
          ...
          {hasPhoto ? (
            ...
            <div className="w-36 h-44 rounded-[16px] bg-gradient-to-br from-[#e8456b] to-indigo-500 flex items-center justify-center shadow-lg mb-5">
          ...
          <div className="flex flex-wrap gap-2 mt-5 justify-center">
            ...
            {profile.video_link && (
              <span className="inline-flex items-center gap-1.5 px-4 py-2 rounded-full text-[11px] font-semibold text-white bg-[#e8456b]">
