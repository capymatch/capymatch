        ...
        >
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-sm font-semibold" style={{ color: "var(--t-text)" }}>
              {location.pathname === "/admin" ? "Admin Dashboard" : location.pathname.includes("/subscriptions") ? "Subscription Management" : location.pathname.includes("/contributions") ? "Contribution Review" : location.pathname.includes("/analytics") ? "Import Analytics" : location.pathname.includes("/users/") ? "User Detail" : location.pathname.includes("/users") ? "User Management" : location.pathname.includes("/universities") ? "University Manager" : location.pathname.includes("/integrations") ? "Integrations" : "Admin"}
            </h2>
          </div>
        </header>
