  ...
  return (
    <div className="space-y-6" data-testid="admin-dashboard">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-3">
        <StatCard icon={Users} label="Total Users" value={stats.total_users} color="bg-teal-600/15 text-teal-600" onClick={() => navigate("/admin/users")} />
        ...
        <StatCard icon={TrendingUp} label="Conversion" value={stats.total_users > 0 ? `${Math.round((stats.plan_counts.pro + stats.plan_counts.premium) / stats.total_users * 100)}%` : "0%"} color="bg-teal-600/15 text-teal-600" />
      </div>
