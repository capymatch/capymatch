                ...
                {isInIframe ? (
                  <div className="space-y-3">
                    ...
                    >
                      ...
                      {copiedUrl ? "Link Copied!" : "Copy App Link to Connect Gmail"} <ChevronRight className="w-4 h-4" />
                    </button>
                    <p className="text-[11px] leading-relaxed px-1" style={{ color: "var(--t-text-muted)" }}>
                      Google requires a full browser window for sign-in. Copy the link above, paste it in a new browser tab, then connect Gmail from there.
                    </p>
                  </div>
                ) : (
                  <a
