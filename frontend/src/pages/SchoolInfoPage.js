...
import {
  ...
  Phone, Activity, Info, Check, GraduationCap, DollarSign,
  ...
  return (
    <div className="max-w-[960px] mx-auto px-4 sm:px-6 pb-16" data-testid="school-info-page">
      ...
      <button onClick={() => navigate(-1)} data-testid="back-button"
        className="inline-flex items-center gap-1.5 text-[12px] text-white/35 font-semibold mb-5 hover:text-[#e8628a] transition-colors">
