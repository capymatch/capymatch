        ...
        <div className="lg:col-span-1">
          ...
          {(program.next_action_due || isPremium || !isBasic) && (
            <div className="rounded-2xl border p-4 mb-4 space-y-5" style={{ backgroundColor: "var(--t-surface)", borderColor: "var(--t-border)" }} data-testid="next-steps-card">
              ...
              {isPremium ? (
                <div className="rounded-lg p-2.5 mt-2" style={{ background: "linear-gradient(135deg, rgba(168,85,247,0.06), rgba(26,138,128,0.04))", border: "1px solid rgba(168,85,247,0.15)" }} data-testid="ai-next-step">
                  {aiSummary ? (
