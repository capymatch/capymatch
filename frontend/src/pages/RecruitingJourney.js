...
function AtAGlanceCard({ program, coaches, isPremium, isBasic, programId, onDraftEmail, onAddCoach, onScheduleFollowup }) {
  ...
  return (
    <div className="rounded-2xl border p-5" style={{ backgroundColor: "var(--t-surface)", borderColor: "var(--t-border)", display: "flex", flexDirection: "column", gap: "16px" }} data-testid="at-a-glance">
