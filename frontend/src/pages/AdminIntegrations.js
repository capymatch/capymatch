...
export default function AdminIntegrations() {
  ...
  const urlDiscovery = data?.url_discovery || {};
  ...
  return (
    <div className="space-y-6 max-w-3xl" data-testid="admin-integrations-page">
                ...
                {gmail.connected_users.map((u) => (
                  ...
                  >
                    ...
                    <Button
                      ...
                      className="text-xs text-teal-400 hover:text-slate-300 hover:bg-slate-500/10 gap-1"
      ...
      <IntegrationCard
        ...
        accent="bg-slate-500/15 text-teal-400"
      >
        <div className="space-y-1">
          {ai.connected ? (
            <>
