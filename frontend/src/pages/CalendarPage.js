            ...
            <div className="rounded-xl p-4 border" style={{ backgroundColor: "var(--t-surface)", borderColor: "var(--t-border)" }}>
              <div className="flex items-center justify-between mb-3">
                ...
                <button
                  ...
                  className="p-1 rounded-lg text-pink-600 hover:bg-pink-600/10 transition-colors"
                >
                  <Plus className="w-4 h-4" />
                </button>
              </div>
            ...
            {upcomingUserEvents.length > 0 ? (
              <div className="space-y-2">
                {upcomingUserEvents.slice(0, 5).map((evt) => {
                  const typeBg = { Camp: "bg-pink-600/15 text-pink-400", Showcase: "bg-blue-500/15 text-blue-400", Tournament: "bg-amber-500/15 text-amber-400", Visit: "bg-emerald-500/15 text-emerald-400", Tryout: "bg-pink-500/15 text-pink-400", Meeting: "bg-cyan-500/15 text-cyan-400", Deadline: "bg-red-500/15 text-red-400", Other: "bg-gray-500/15 text-gray-400" };
                  const colorBar = { Camp: "bg-pink-600", Showcase: "bg-blue-500", Tournament: "bg-amber-500", Visit: "bg-emerald-500", Tryout: "bg-pink-500", Meeting: "bg-cyan-500", Deadline: "bg-red-500", Other: "bg-gray-500" };
                  return (
                    <div
                      key={evt.event_id}
                ...
                {upcomingUserEvents.length > 5 && (
                  <button className="w-full text-sm text-pink-500 hover:text-pink-400 transition-colors pt-2">
