        ...
        <div className="p-6 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2.5 rounded-lg text-sm border focus:outline-none focus:border-purple-500/50"
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-3 py-2.5 rounded-lg text-sm border focus:outline-none focus:border-purple-500/50 resize-none"
              style={{ backgroundColor: "var(--t-input-bg)", borderColor: "var(--t-border)", color: "var(--t-text)" }}
                ...
                return (
                  <div
                    ...
                    className={`h-28 p-2 border-b border-r transition-colors cursor-pointer ${
                      isToday(day) ? "bg-purple-500/10" : isSelected ? "bg-purple-500/5" : ""
                    }`}
                    style={{ borderColor: "var(--t-border)" }}
                    data-testid={`calendar-day-${day}`}
                  >
                    <div className="flex items-center justify-between mb-1">
                      <span className={`text-sm font-medium ${isToday(day) ? "text-purple-500" : ""}`}
                        style={{ color: isToday(day) ? undefined : "var(--t-text-secondary)" }}>
                        {day}
                      </span>
                      {dayEvents.length > 0 && (
                        <span className="w-5 h-5 rounded-full bg-purple-500/20 text-purple-500 text-[10px] font-bold flex items-center justify-center">
                          {dayEvents.length}
                        </span>
                      )}
                    </div>
